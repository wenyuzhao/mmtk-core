...
define_side_metadata_specs!(
    ...
    CHUNK_MARK   = (global: false, log_num_of_bits: 3, log_bytes_in_region: crate::util::heap::chunk_map::Chunk::LOG_BYTES),// The block is in a mutator allocator's local allocation buffer
