...
pub(crate) const fn meta_byte_lshift(metadata_spec: &SideMetadataSpec, data_addr: Address) -> u8 {
...
pub(crate) const fn meta_byte_mask(metadata_spec: &SideMetadataSpec) -> u8 {
