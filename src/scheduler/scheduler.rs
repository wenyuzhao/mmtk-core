    ...
    pub fn new() -> Arc<Self> {
        ...
        Arc::new(Self {
            work_buckets: enum_map! {
                ...
                WorkBucketStage::RCIncs => WorkBucket::new(false, worker_monitor.clone()),
                WorkBucketStage::RCEva => WorkBucket::new(false, worker_monitor.clone()),
                WorkBucketStage::RCPreRelease => WorkBucket::new(false, worker_monitor.clone()),
