...
struct GCStat {
    ...
    pub alloc_small_objects: usize,
    pub alloc_small_objects_slow: usize,
    pub alloc_small_volume: usize,
    pub alloc_medium_objects: usize,
    pub alloc_medium_objects_slow: usize,
    pub alloc_medium_volume: usize,
    pub alloc_medium_refill: usize,
    pub alloc_medium_refill_failure: usize,
...
impl GCStat {
    print_keys_and_values![
        ...
        alloc_volume,
        alloc_small_objects,
        alloc_small_objects_slow,
        alloc_small_volume,
        alloc_medium_objects,
        alloc_medium_objects_slow,
        alloc_medium_volume,
        alloc_medium_refill,
        alloc_medium_refill_failure,
        alloc_los_objects,
        alloc_los_volume,
        promoted_objects,
        promoted_volume,
...
static STAT: Mutex<GCStat> = Mutex::new(GCStat {
    ...
    alloc_objects: 0,
    alloc_volume: 0,
    alloc_small_objects: 0,
    alloc_small_objects_slow: 0,
    alloc_small_volume: 0,
    alloc_medium_objects: 0,
    alloc_medium_objects_slow: 0,
    alloc_medium_volume: 0,
    alloc_medium_refill: 0,
    alloc_medium_refill_failure: 0,
    alloc_los_objects: 0,
    alloc_los_volume: 0,
    promoted_objects: 0,
    promoted_volume: 0,
